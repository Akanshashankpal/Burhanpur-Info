      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="text-gray-700 space-y-2">
            <p><strong>📍 Address:</strong> Collector Office, Mohammadpura, Raver Road, Burhanpur - 450331</p>
            <p><strong>📞 Phone:</strong> <a href="tel:+917325255300" className="text-blue-600">07325-255300</a></p>
