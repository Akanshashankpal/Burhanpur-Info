...
import ImageSlider from '../../../ExplorePart/PlaceDetails/PlaceImg/Slider/ImageSlider';
import { motion } from 'framer-motion';
...
//       <h1 className="text-4xl font-bold text-amber-700 mb-6">Jama Masjid</h1>
//       <p className="text-lg text-gray-700">
//         A lesser-known masterpiece radiating Mughal elegance and romance. Known for its connection
//         to Mumtaz Mahal, this monument holds historic and emotional significance in Burhanpur.
//       </p>
//     </div>
//   );
